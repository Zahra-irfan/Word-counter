...
const answer = await inquirer.prompt([
    {
        name: "sentence",
        type: "string",
        message: "Please enter a sentence of which you want the characters and words to be counted: ",
    },
]);
if (answer.sentence.length > 0) {
    ...
    if (functions.count === "Words") {
        ...
        // console.log(words);
        console.log(`Total number of words in the given sentence is: "${words.length}".`);
    }
    else if (functions.count === "Characters") {
        const characters = answer.sentence.replace(/\s/g, "").split("");
        // console.log(characters);
        console.log(`Total number of characters in the given sentence is: "${characters.length}".`);
    }
        ...
        console.log(`Total number of characters with spaces in the given sentence is: "${charactersWithSpaces.length}".`);
    }
    else {
        const words = answer.sentence.trim().split(" ");
        // console.log(words);
